...
class MovieList extends React.Component {
   render() {
      const movies = ["Pride and Prejudice (2005)", "How to Train Your Dragon", "Spider-Man: Across the Spider-Verse", "Prince of Persia: The Sands of Time", "The Man From Nowhere"];
      return (
      <div>
